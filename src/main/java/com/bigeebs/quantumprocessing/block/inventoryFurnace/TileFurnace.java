 ...
 */
public class TileFurnace extends TileEntity implements IInventory, IUpdatePlayerListBox {
     ...
     */
    public double fractionOffFuelRemaining(int fuelSlot)
    {
     ...
     */
    public int secondsOffFuelRemaining(int fuelSlot)
    {
    ...
    /**
     * Returns the amount of the cook time completed on the currently cooking item
     * @return fraction remaining, between 0 - 1
     */
    ...
    public void update() {
        ...
        if (canSmelt()) {
            ...
            // If cookTime has reached maxCookTime smelt the item and rest cookTime
    ...
    /**
     *      for each fuel slot: decreases the burn time, checks if burnTimeRemaining = 0 and tries to consume a new piece of fuel
    ...
    {
        int burntime = TileFurnace.getItemBurnTime(stack);  // just use the vanilla values
